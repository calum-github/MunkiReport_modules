			...
			<div class="panel panel-default">
				...
				<div class="list-group scroll-box">
					...
					<?php	$munkireport = new Munkireport_model();
							$sql = "SELECT region_name, COUNT(1) AS count
									FROM site_info
									GROUP BY region_name
									ORDER BY COUNT DESC";
					?>
						<?php foreach($munkireport->query($sql) as $obj): ?>
							<?php if (empty($obj->region_name)):?>
								<a class="list-group-item"><span data-i18n="unknown">Unknown</span>
									<span class="badge pull-right"><?php echo $obj->count; ?></span>
								</a>
							<?php else: ?>
								<a href="<?php echo url('show/listing/site_info/#'.$obj->region_name); ?>" class="list-group-item"><?php echo $obj->region_name; ?>
									<span class="badge pull-right"><?php echo $obj->count; ?></span>
								</a>
							<?php endif; ?>
						<?php endforeach; ?>
